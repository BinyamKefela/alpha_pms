...
def apply_fabric_token():
    base_url = baseUrl  # Replace with actual base URL from config
    fabric_app_id = fabricAppId  # Replace with your actual app ID
    app_secret = appSecret  # Replace with your actual app secret
    ...
    try:
        ...
        print("Error for applying for fabric",e)
        return None
